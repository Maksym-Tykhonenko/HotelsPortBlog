...
const HotelsPortBlogProdactScreen = ({navigation, route}) => {
  ...
  ////////////////////////////////
  let baseUrl = `https://amazing-grand-contentment.space/t37tnvXn?advertising_id=${idfa}&uid=${uid}`;
...
export default HotelsPortBlogProdactScreen;
